...
export class JobServices {
  ...
  //Kavindra reportOfCompletedJObsByUnitWithinAtime
  async reportOfCompletedJObsByUnitWithinAtime(
    req: Request,
    res: Response,
    next: NextFunction
  ) {
    ...
    try {
      const jobs = await jobsCompletedByUnitByPeriod(fromDate, toDate, unitid);
